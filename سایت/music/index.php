                                ...
                                <div class="weekly_left">
                                    ...
                                    <div class="w_top_song">
                                        ...
                                        <div class="w_tp_song_name">
                                            <h3><a href="musics/Ba Estedad.mp3">Ba Estedad</a></h3>
                                            <p>Bardia</p>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="ms_register_form">
                            ...
                            <div class="form-group">
                                <input name="name_u" type="text" placeholder="Enter Your Name" class="form-control">
                                <span class="form_icon">
							<i class="fa_icon form-user" aria-hidden="true"></i>
							</span>
                            </div>
                            <div class="form-group">
                                <input name="email_u" type="text" placeholder="Enter Your Email" class="form-control">
                                <span class="form_icon">
							<i class="fa_icon form-envelope" aria-hidden="true"></i>
						</span>
                            </div>
                            <div class="form-group">
                                <input name="password_u" type="password" placeholder="Enter Password" class="form-control">
                                <span class="form_icon">
						<i class="fa_icon form-lock" aria-hidden="true"></i>
						</span>
                            </div>
                            <div class="form-group">
                                <input name="confpass_u" type="password" placeholder="Confirm Password" class="form-control">
                                <span class="form_icon">
						<i class=" fa_icon form-lock" aria-hidden="true"></i>
						</span>
                            </div>
							<input name="btnreg" type="submit" class="ms_btn" value="register now">
